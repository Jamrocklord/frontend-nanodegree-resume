...
var HTMLcontactGeneric = "<li class='flex-item'><span class='orange-text'></span><span class='white-text'>%data%</span></li>";
...
var HTMLeducation= "<div class='education'>%data%</div>";
...
function initializeMap() {
  ...
  */
  function locationFinder() {
    ...
    locations.push(contact_info.Address);
